...
namespace Laborator1.Services

    {
        ...
        public Task<ServiceResponse<RegisterResponse, IEnumerable<IdentityError>>> RegisterUser(RegisterRequest registerRequest)
        {
            throw new NotImplementedException();
        }

        public Task<bool> ConfirmUserRequest(ConfirmUserRequest confirmUserRequest)
        {
            throw new NotImplementedException();
        }

        public Task<ServiceResponse<LoginResponse, string>> LoginUser(LoginRequest loginRequest)
        {
            throw new NotImplementedException();
        }
    }
